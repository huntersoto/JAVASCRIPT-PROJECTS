function myFunction()    {
    ...
    document.getElementById("Button_Text").innerHTML = str1; //Establishing the function using the first variable and Button_Text HTML ID
    document.getElementById("Button2_Text").innerHTML = str2; //Establishing the function using the second varibale and Button2_Text HTML ID
}